  ...
  return (
    <div>
      ...
      <button 
        ...
        onClick={() => addNotification({ type: 'info', title: 'Test', message: 'Test message' })}
      >
        Add Notification
      </button>
      <button 
      ...
      <button 
        data-testid="login" 
        onClick={() => login({ username: 'testuser', email: 'test@example.com' })}
      >
        Login
      </button>
...
const renderWithProviders = (component: React.ReactElement, providers: React.ComponentType<{ children: React.ReactNode }>[] = [AppProvider]) => {
