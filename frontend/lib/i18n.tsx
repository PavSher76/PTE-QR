...
const translations = {
  ru: {
    ...
    'about.description': 'Система проверки актуальности документов через QR-коды с интеграцией в ENOVIA PLM',
    'about.features': 'Основные возможности',
    'about.technologies': 'Технологии',
    'about.contacts': 'Контакты',
    'about.feature1': 'Сканирование QR-кодов документов для проверки их актуальности',
    'about.feature2': 'Интеграция с системой ENOVIA PLM',
    'about.feature3': 'Многоязычная поддержка (русский, английский, китайский)',
    'about.feature4': 'Адаптивный дизайн для мобильных устройств',
    'about.feature5': 'Темная и светлая темы оформления',
    'about.feature6': 'Безопасная аутентификация пользователей',
    'about.frontend': 'Frontend',
    'about.backend': 'Backend',
    'about.contactText': 'Если у вас есть вопросы или предложения по улучшению системы, пожалуйста, обратитесь к администратору системы.',
  },
  en: {
    ...
    'about.description': 'Document status verification system via QR codes with ENOVIA PLM integration',
    'about.features': 'Key Features',
    'about.technologies': 'Technologies',
    'about.contacts': 'Contacts',
    'about.feature1': 'Scanning QR codes of documents to check their relevance',
    'about.feature2': 'Integration with ENOVIA PLM system',
    'about.feature3': 'Multilingual support (Russian, English, Chinese)',
    'about.feature4': 'Responsive design for mobile devices',
    'about.feature5': 'Dark and light themes',
    'about.feature6': 'Secure user authentication',
    'about.frontend': 'Frontend',
    'about.backend': 'Backend',
    'about.contactText': 'If you have questions or suggestions for improving the system, please contact the system administrator.',
  },
  zh: {
    'app.title': 'PTE QR 系统',
    ...
    'about.title': '关于系统',
    'about.description': '通过二维码验证文档状态的系统，集成ENOVIA PLM',
    'about.features': '主要功能',
    'about.technologies': '技术栈',
    'about.contacts': '联系方式',
    'about.feature1': '扫描文档二维码检查其相关性',
    'about.feature2': '与ENOVIA PLM系统集成',
    'about.feature3': '多语言支持（俄语、英语、中文）',
    'about.feature4': '移动设备响应式设计',
    'about.feature5': '深色和浅色主题',
    'about.feature6': '安全的用户认证',
    'about.frontend': '前端',
    'about.backend': '后端',
    'about.contactText': '如果您对系统改进有疑问或建议，请联系系统管理员。',
  },
}
