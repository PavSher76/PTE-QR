...
async def frontend_root():
    ...
    <head>
        ...
        <style>
            ...
            .api-link { display: block; margin: 10px 0; padding: 10px; background: #f5f5f5; text-decoration: none; color: #333; border-radius: 5px; }
    ...
    <body>
        <div class="container">
            ...
            <a href="/api/v1/health/metrics" class="api-link">📊 Prometheus Metrics</a>
            <a href="/api/v1/health/status" class="api-link">📈 System Status</a>
            
            <h2>Document Endpoints</h2>
            <a href="/api/v1/documents/TEST-DOC-001/revisions/A/status?page=1" class="api-link">📄 Document Status Check</a>
