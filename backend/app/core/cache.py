...
class CacheManager:
    ...
    async def delete_pattern(self, pattern: str) -> int:
        ...
        try:
            ...
            logger.error("Failed to delete pattern from cache", pattern=pattern, error=str(e))
            return 0
    ...
    async def expire(self, key: str, ttl: int) -> bool:
        ...
        try:
            ...
            logger.error("Failed to set cache expiration", key=key, ttl=ttl, error=str(e))
            return False
    ...
    async def increment(self, key: str, amount: int = 1) -> Optional[int]:
        ...
        try:
            ...
            logger.error("Failed to increment cache value", key=key, amount=amount, error=str(e))
            return None
