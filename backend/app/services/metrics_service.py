...
class MetricsService:
    ...
    def __init__(self):
        ...
        self.system_cpu_usage = Gauge(
            'pte_qr_system_cpu_usage_percent',
            'System CPU usage percentage'
        )
        
        self.system_memory_usage = Gauge(
            'pte_qr_system_memory_usage_percent',
            'System memory usage percentage'
        )
        
        self.system_disk_usage = Gauge(
            'pte_qr_system_disk_usage_percent',
            'System disk usage percentage'
        )
        
        # Application metrics
        self.active_connections = Gauge(
            'pte_qr_active_connections',
            'Number of active connections'
        )
        
        self.uptime_seconds = Gauge(
            'pte_qr_uptime_seconds',
    ...
    def record_qr_code_generated(self, doc_uid: str, revision: str):
        ...
        self.qr_codes_generated_total.labels(
            doc_uid=doc_uid,
            revision=revision
        ).inc()
    ...
    def record_document_status_check(
        ...
        self.document_status_checks_total.labels(
            doc_uid=doc_uid,
            revision=revision,
            is_actual=str(is_actual)
        ).inc()
    
    def record_enovia_request(
        self,
        endpoint: str,
        status: str,
        duration: float
        ...
        self.enovia_requests_total.labels(
            endpoint=endpoint,
            status=status
        ).inc()
    ...
    def get_metrics_dict(self) -> Dict[str, Any]:
        ...
        return {
            "api": {
                ...
                "request_duration": self._get_histogram_value(self.api_request_duration)
            },
            "qr_codes": {
                "generated_total": self._get_counter_value(self.qr_codes_generated_total),
                "verified_total": self._get_counter_value(self.qr_codes_verified_total)
            },
            "documents": {
                "status_checks_total": self._get_counter_value(self.document_status_checks_total)
            },
            "enovia": {
                "requests_total": self._get_counter_value(self.enovia_requests_total),
                "request_duration": self._get_histogram_value(self.enovia_request_duration)
            },
            "cache": {
    ...
    def get_health_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "memory_usage_percent": self.system_memory_usage._value._value,
            "disk_usage_percent": self.system_disk_usage._value._value,
            "total_requests": sum(self._get_counter_value(self.api_requests_total).values()),
            "total_qr_codes": sum(self._get_counter_value(self.qr_codes_generated_total).values())
        }
