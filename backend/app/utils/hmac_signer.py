...
class HMACSigner:
    ...
    def generate_signature(self, doc_uid: str, revision: str, page: int, timestamp: Optional[int] = None) -> str:
        """
    ...
    def verify_signature(self, doc_uid: str, revision: str, page: int, timestamp: int, signature: str) -> bool:
        """
    ...
    def generate_qr_url(self, doc_uid: str, revision: str, page: int, base_url: str = "https://qr.pti.ru") -> str:
        """
