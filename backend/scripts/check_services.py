...
def check_postgresql(database_url="postgresql://postgres:postgres@localhost:5432/pte_qr_test"):
...
def main():
    ...
    database_url = sys.argv[2] if len(sys.argv) > 2 else "postgresql://postgres:postgres@localhost:5432/pte_qr_test"
