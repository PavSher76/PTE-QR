...
class TestDocumentStatusAuth:
    ...
    def test_document_status_nonexistent_document_without_auth(self, client: TestClient):
    ...
    def test_document_status_nonexistent_document_with_auth(self, client: TestClient, test_user):
    ...
    def test_document_status_gdpr_data_minimization(self, client: TestClient):
        ...
        required_fields = ["doc_uid", "revision", "page", "is_actual", "business_status", "links", "metadata"]
        ...
        for field in sensitive_fields:
            assert field not in data, f"Sensitive field {field} should not be included without authentication"
    ...
    def test_document_status_cache_behavior_with_auth(self, client: TestClient, test_user):
