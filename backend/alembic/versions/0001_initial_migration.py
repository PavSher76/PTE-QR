...
def upgrade() -> None:
    ...
    op.create_table('documents',
        ...
        sa.ForeignKeyConstraint(['created_by'], ['pte_qr.users.id'], ),
        sa.ForeignKeyConstraint(['updated_by'], ['pte_qr.users.id'], ),
        sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table('audit_logs',
        ...
        sa.ForeignKeyConstraint(['changed_by'], ['pte_qr.users.id'], ),
        sa.PrimaryKeyConstraint('id'),
        schema='pte_qr'
    )
    ...
    op.create_table('user_sessions',
        ...
        sa.Column('user_agent', sa.Text(), nullable=True),
        sa.Column('is_active', sa.Boolean(), nullable=True),
        sa.ForeignKeyConstraint(['user_id'], ['pte_qr.users.id'], ),
        sa.PrimaryKeyConstraint('id'),
